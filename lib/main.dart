                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            color: Colors.white,
                            child: Image(image: AssetImage('images/motherboard.jpg')),
                          ),
                          Container(
                            color: Colors.black,
                            child: Center(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            color: Colors.white,
                            child: Image(image: AssetImage('images/power.jpg'),height: 90,width: 140,),
                          ),
                          Container(
                            color: Colors.black,
                            child: Center(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            color: Colors.white,
                            child: Image(image: AssetImage('images/cases.jpg'),width:140,height: 90,),
                          ),
                          Container(
                            color: Colors.black,
                            child: Center(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            color: Colors.white,
                            child: Image(image: AssetImage('images/cooling.jpg'),height: 90,width: 140,),
                          ),
                          Container(
                            color: Colors.black,
                            child: Center(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            color: Colors.white,
                            child: Image(image: AssetImage('images/acces.jpg'),height: 90,width: 200,),
                          ),
                          Container(
                            color: Colors.black,
                            child: Center(
